                ...
                <div class="bg-white overflow-auto p-4">
                    <form action="{{ url('/save-campaign') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="ringba_campaign_id" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="campaign id..." />
                        </div>
