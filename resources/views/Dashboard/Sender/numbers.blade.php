@section('title') {{'Sender Number'}} @endsection
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            ...
            <div class="create-button text-right">
                <a href="{{ URL('/create-number') }}" class="p-2 bg-sidebar rounded text-white">ADD SENDER NUMBER</a>
            </div>
                            ...
                            @foreach($numbers as $number)
                                <tr>
                                    ...
                                    <td class="lg:flex text-left py-3 px-5 text-2xl" colspan="2">
                                        <a class="hover:text-green-300" href="{{ url('/edit-number/'.$number->id) }}"><i class="fas fa-edit lg:mr-3"></i></a>
