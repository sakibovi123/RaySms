                ...
                <div class="bg-white overflow-auto p-4">
                    <form action="{{ URL('/send-message-to-customers') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <select required name="sender_number_id" id="" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
